    ...
    function customCursor(isShadowTrue) {
        ...
        if (wrapper && !isMobile.any()) {
            ...
            function mouseActions(e) {
                ...
                const rotateAngle = 27;
                cursorPointer ? cursorPointer.style.transform = `translate3d(${e.clientX - cursorPointerStyle.width / 2}px, ${e.clientY - cursorPointerStyle.height / 2}px, 0) rotate(${rotateAngle}deg)` : null;
                ...
                cursorPointer.style.transform = `translate3d(${e.clientX - 2}px, ${e.clientY - 34}px, 0) rotate(${rotateAngle}deg)`;
            }
